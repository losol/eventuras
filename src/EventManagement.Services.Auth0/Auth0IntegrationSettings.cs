...
namespace EventManagement.Services.Auth0
{
    internal class Auth0IntegrationSettings
    {
        ...
        /// <summary>
        /// Auth0 will call back to http://{StartupUrl}{CallbackPath}.
        ...
        /// <summary>
        /// Does someone need to change this?
        /// </summary>
        ...
        /// <summary>
        /// Optional Auth0 API identifier to be used as the audience param
        /// when obtaining token from Auth0.
        /// </summary>
        public string ApiIdentifier { get; set; }

        /// <summary>
        /// This lambda determines whether user consent for non-essential cookies is needed
        /// for a given request. Set to true in production.
        /// </summary>
