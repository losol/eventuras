...
{
    public static IServiceCollection AddPowerOffice(this IServiceCollection services, IConfiguration configuration)
    {
        services.AddOptions<PowerOfficeOptions>().ValidateDataAnnotations().Bind(configuration);
