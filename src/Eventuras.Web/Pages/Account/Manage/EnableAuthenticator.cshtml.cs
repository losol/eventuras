...
namespace Eventuras.Pages.Account.Manage;
...
public class EnableAuthenticatorModel : PageModel
{
    ...
    private string GenerateQrCodeUri(string email, string unformattedKey)
        => string.Format(AuthenicatorUriFormat, _urlEncoder.Encode("losol.Eventuras"), _urlEncoder.Encode(email), unformattedKey);
}