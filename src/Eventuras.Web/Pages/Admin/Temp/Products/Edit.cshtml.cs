...
public class EditModel : PageModel
{
    ...
    public EditModel(ApplicationDbContext context, IEventInfoRetrievalService eventInfoRetrievalService)
    {
        _context = context;
    ...
    public async Task<IActionResult> OnGetAsync(int? id)
    {
        ...
        Product = await _context.Products.Include(p => p.EventInfo).SingleOrDefaultAsync(m => m.ProductId == id);
