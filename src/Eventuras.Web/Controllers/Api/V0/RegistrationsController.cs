...
public class RegistrationsController : Controller
{
    ...
    public async Task<ActionResult> UpdateCertificateComment([FromRoute] int id, [FromBody] CertificateCommentVM vm)
    {
        ...
        try { await _registrationsService.UpdateCertificateComment(id, vm.CertificateComment); }
        catch (ArgumentException) { return BadRequest(); }
    ...
    public async Task<ActionResult> UpdateCustomerInfo([FromRoute] int id, [FromBody] CustomerInfoVM vm)
    {
        ...
        try
        {
            await _registrationsService.UpdateCustomerInfo(id, vm.CustomerName, vm.CustomerEmail, vm.CustomerVatNumber, vm.CustomerInvoiceReference);

            await _registrationsService.UpdateCustomerAddress(id, vm.CustomerAddress, vm.CustomerCity, vm.CustomerZip, vm.CustomerCountry);
        }
        catch (ArgumentException) { return BadRequest(); }
    ...
    public async Task<ActionResult> SetPaymentMethod([FromRoute] int id, [FromRoute] PaymentProvider paymentmethod)
    {
        ...
        try { await _registrationsService.UpdatePaymentMethod(id, paymentmethod); }
        catch (ArgumentException) { return BadRequest(); }
    ...
    public async Task<ActionResult> UpdateRegistrationStatus([FromRoute] int id, [FromRoute] RegistrationStatus status)
    {
        ...
        catch (Exception e) when (e is InvalidOperationException || e is ArgumentException) { return BadRequest(); }
    }
