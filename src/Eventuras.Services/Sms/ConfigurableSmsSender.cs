...
/// <summary> Same as <see cref="Eventuras.Services.Email.ConfigurableEmailSender" /> but for SMS. </summary>
internal class ConfigurableSmsSender : ISmsSender
{
    ...
    public ConfigurableSmsSender(IEnumerable<IConfigurableSmsSenderComponent> components, ILogger<ConfigurableSmsSender> logger)
    {
    ...
    public async Task SendSmsAsync(string to, string body)
    {
        ...
        if (sender != null) await sender.SendSmsAsync(to, body);
    }
