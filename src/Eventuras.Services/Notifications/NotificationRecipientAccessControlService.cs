...
internal class NotificationRecipientAccessControlService : INotificationRecipientAccessControlService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (user.IsAnonymous()) throw new NotAccessibleException("Anonymous users are not permitted to access any " + "notification recipient info.");
        ...
        return query.Where(r => r.Notification.OrganizationId == orgId && r.Notification.Organization.Members.Any(m => m.UserId == userId));
    }
}