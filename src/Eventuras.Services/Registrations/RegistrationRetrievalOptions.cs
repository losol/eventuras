...
public class RegistrationRetrievalOptions
{
    ...
    /// <summary> Just a helpful shortcut for retrieving registrations with user and event info loaded. </summary>
    public static readonly RegistrationRetrievalOptions UserAndEvent = new()
    {
        LoadUser = true,
        LoadEventInfo = true,
    };
    ...
    public static readonly RegistrationRetrievalOptions ForCertificateRendering = new()
    {
        LoadCertificate = true,
    };
}