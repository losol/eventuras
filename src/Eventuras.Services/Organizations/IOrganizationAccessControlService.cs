...
{
    /// <summary> Checks whether the authenticated user has access to obtain the specified organization info. </summary>
    ...
    /// <summary> Checks whether the authenticated user has access to update the specified organization. </summary>
