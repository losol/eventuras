...
{
    /// <summary>
    /// Find org member record for the given app user. If no <c> organization </c> is passed, then returns member record for the current organization (see
    /// <see cref="ICurrentOrganizationAccessorService" />).
    /// </summary>
    ...
    /// <summary>
    /// Ensures org member record for the given app user. If no <c> organization </c> is passed, then returns member record for the current organization (see
    /// <see cref="ICurrentOrganizationAccessorService" />).
    /// </summary>
    ...
    /// <summary> Removes membership for the given user, if any. If no org is passed, then removes from the current org. </summary>
