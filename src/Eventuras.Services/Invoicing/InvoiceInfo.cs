...
/// <summary> POCO for new invoice. </summary>
public class InvoiceInfo
{
    ...
    public static InvoiceInfo CreateFromOrderList(IReadOnlyCollection<Order> orders)
    {
        return new InvoiceInfo
        {
            ...
            CustomerEmail = orders.FirstFilled(o => o.CustomerEmail ?? o.Registration.CustomerEmail ?? o.Registration.User.Email),
            CustomerName = orders.FirstFilled(o => o.CustomerName ?? o.Registration.ParticipantName ?? o.Registration.User.Name),
            ...
            Lines = orders.SelectMany(o => new[]
                ...
                }.Concat(o.OrderLines.Select(l => new InvoiceLine
                {
                    ...
                    Description = l.ProductVariantId.HasValue ? $"{l.ProductName} ({l.ProductVariantName})" : l.ProductName,
    ...
    {
        var customerName = order.CustomerName ?? order.Registration.ParticipantName ?? order.Registration.User.Name;
        ...
        if (order.Registration.EventInfo.DateStart != null) invoiceDescription += $" {order.Registration.EventInfo.DateStart:d}";

        if (order.Registration.EventInfo.DateEnd != null) invoiceDescription += "-" + $"{order.Registration.EventInfo.DateEnd:d}";
