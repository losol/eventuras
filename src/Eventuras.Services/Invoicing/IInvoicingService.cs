...
{
    /// <summary>
    /// Creates new invoice from the given order array. Allows to explicitly specify invoice information via the <c> info </c> param. If no info is
    /// specified, it will be generated from the given <c> orders </c> automatically.
    /// </summary>
