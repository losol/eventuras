...
{
    public static IServiceCollection AddTalentLmsIfEnabled(this IServiceCollection services, IConfigurationSection configuration)
    {
        ...
        services.AddOptions<TalentLmsSettings>().ValidateDataAnnotations().Bind(configuration);
