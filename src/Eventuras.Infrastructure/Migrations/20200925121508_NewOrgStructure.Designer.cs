...
namespace Eventuras.Infrastructure.Migrations
{
    ...
    [Migration("20200925121508_NewOrgStructure")]
    partial class NewOrgStructure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eventuras.Domain.Organization", b =>
                {
                    ...
                    b.Property<string>("EventurasHostname")
                        .HasColumnType("character varying(300)")
                        .HasMaxLength(300);
                    ...
                    b.HasIndex("EventurasHostname")
                        .IsUnique()
                        .HasFilter("\"EventurasHostname\" IS NOT NULL AND \"Active\" = true");
            ...
            modelBuilder.Entity("Eventuras.Domain.Organization", b =>
                {
                    b.HasOne("Eventuras.Domain.Organization", "ParentOrganization")
