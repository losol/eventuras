...
public class EventCollectionController : ControllerBase
{
    ...
    {
        _eventCollectionManagementService =
            eventCollectionManagementService ?? throw new ArgumentNullException(nameof(eventCollectionManagementService));

        _eventCollectionRetrievalService =
            eventCollectionRetrievalService ?? throw new ArgumentNullException(nameof(eventCollectionRetrievalService));
    }
    ...
    {
        var collections = await _eventCollectionRetrievalService.ListCollectionsAsync(cancellationToken: cancellationToken);

        return Ok(collections.Select(c => new EventCollectionDto(c)).ToArray());
    }
    ...
    {
        var c = await _eventCollectionRetrievalService.GetCollectionByIdAsync(id, cancellationToken: cancellationToken);
    ...
    {
        var collection = await _eventCollectionRetrievalService.GetCollectionByIdAsync(id,
