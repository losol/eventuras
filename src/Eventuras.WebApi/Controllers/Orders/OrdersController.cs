...
public class OrdersController : ControllerBase
{
    ...
    public OrdersController(IOrderRetrievalService orderRetrievalService, IOrderManagementService orderManagementService)
    {
    ...
    public async Task<IActionResult> ListAccessibleOrders([FromQuery] OrdersQueryDto query, CancellationToken cancellationToken = default)
    {
        ...
        return Ok(PageResponseDto<OrderDto>.FromPaging(query, paging, o => new OrderDto(o)));
    }
    ...
    {
        var order = await _orderManagementService.CreateOrderForRegistrationAsync(request.RegistrationId, request.Lines, cancellationToken);
