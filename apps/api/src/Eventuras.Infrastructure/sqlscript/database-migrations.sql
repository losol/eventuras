...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260916201305_AddProcessingPurposes') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260916201305_AddProcessingPurposes') THEN
    CREATE UNIQUE INDEX "IX_PurposeDecisions_UserId_OrganizationUuid_Code" ON "PurposeDecisions" ("UserId", "OrganizationUuid", "Code") WHERE "RegistrationUuid" IS NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260916201305_AddProcessingPurposes') THEN
    CREATE UNIQUE INDEX "IX_PurposeDecisions_UserId_OrganizationUuid_Code_RegistrationU~" ON "PurposeDecisions" ("UserId", "OrganizationUuid", "Code", "RegistrationUuid") WHERE "RegistrationUuid" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260916201305_AddProcessingPurposes') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260916201305_AddProcessingPurposes', '10.0.11');
    END IF;
END $EF$;
COMMIT;
