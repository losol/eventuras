...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260920213058_AddUuidToOrganizationSettings') THEN
    ALTER TABLE "OrganizationSettings" ADD "Uuid" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260920213058_AddUuidToOrganizationSettings') THEN
    CREATE UNIQUE INDEX "IX_OrganizationSettings_Uuid" ON "OrganizationSettings" ("Uuid");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260920213058_AddUuidToOrganizationSettings') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260920213058_AddUuidToOrganizationSettings', '10.0.11');
    END IF;
END $EF$;
COMMIT;
