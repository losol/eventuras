        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProcessingPurposes_Kind", "\"Kind\" IN (1, 2)");
                    table.CheckConstraint("CK_ProcessingPurposes_SpecialCategoryIsOptIn", "NOT \"HasSpecialCategoryData\" OR \"Kind\" = 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationUuid = table.Column<Guid>(type: "uuid", nullable: false),
                    Code = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    RegistrationUuid = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurposeDecisions_Decision", "\"Decision\" IN (1, 2)");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurposeDecisions_Registrations_RegistrationUuid",
                        column: x => x.RegistrationUuid,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurposeDecisions_RegistrationUuid",
                table: "PurposeDecisions",
                column: "RegistrationUuid");

            migrationBuilder.CreateIndex(
                name: "IX_PurposeDecisions_UserId_OrgUuid_Code",
                table: "PurposeDecisions",
                columns: new[] { "UserId", "OrganizationUuid", "Code" },
                unique: true,
                filter: "\"RegistrationUuid\" IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_PurposeDecisions_UserId_OrgUuid_Code_RegistrationUuid",
                table: "PurposeDecisions",
                columns: new[] { "UserId", "OrganizationUuid", "Code", "RegistrationUuid" },
                unique: true,
                filter: "\"RegistrationUuid\" IS NOT NULL");
        }
