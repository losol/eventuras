...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE INDEX IF NOT EXISTS "pages_rels_topics_id_idx" ON "pages_rels" USING btree ("topics_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_rels_topics_id_idx" ON "_pages_v_rels" USING btree ("topics_id");`)
}
