...
import { PageResponseDtoOfRegistrationDto, RegistrationDto } from '@/lib/eventuras-sdk';
...
const AdminRegistrationsList: React.FC = () => {
  ...
  const [result, setResult] = useState<PageResponseDtoOfRegistrationDto | null>(null);
