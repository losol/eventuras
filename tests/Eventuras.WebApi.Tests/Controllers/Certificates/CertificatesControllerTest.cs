...
public class CertificatesControllerTest : IClassFixture<CustomWebApiApplicationFactory<Startup>>
{
    private readonly CustomWebApiApplicationFactory<Startup> _factory;

    public CertificatesControllerTest(CustomWebApiApplicationFactory<Startup> factory)
    {
        _factory = factory;
    }
    ...
    {
        var response = await _factory.CreateClient().GetAsync("/v3/certificates/1");
    ...
    {
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().GetAsync("/v3/certificates/1");
    ...
    public async Task Should_Not_Allow_To_Get_Certificate_To_Another_Regular_User()
    {
        ...
        var response = await _factory.CreateClient().AuthenticatedAs(anotherUser.Entity).GetAsync($"/v3/certificates/{cert.Entity.CertificateId}");
    ...
    public async Task Should_Allow_To_Get_Certificate_To_Reg_User()
    {
        ...
        var response = await _factory.CreateClient().AuthenticatedAs(user.Entity).GetAsync($"/v3/certificates/{cert.Entity.CertificateId}");
    ...
    public async Task Should_Allow_To_Get_Certificate_To_Power_Admin(string role)
    {
        ...
        var response = await _factory.CreateClient().Authenticated(role: role).GetAsync($"/v3/certificates/{cert.Entity.CertificateId}");
    ...
    public async Task Should_Return_Certificate_Pdf_Using_Query_Param()
    {
        ...
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().GetAsync($"/v3/certificates/{cert.Entity.CertificateId}?format=pdf");
