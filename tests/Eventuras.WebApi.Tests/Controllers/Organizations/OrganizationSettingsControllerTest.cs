...
public class OrganizationSettingsControllerTest : IClassFixture<CustomWebApiApplicationFactory<Startup>>
{
    ...
    {
        var response = await _factory.CreateClient().GetAsync("/v3/organizations/1/settings");
    ...
    {
        var response = await _factory.CreateClient().Authenticated().GetAsync("/v3/organizations/1/settings");
    ...
    {
        var response = await _factory.CreateClient().AuthenticatedAsAdmin().GetAsync("/v3/organizations/10001/settings");
    ...
    public async Task List_Should_Not_Be_Available_To_Other_Org_Admin()
    {
        ...
        var response = await _factory.CreateClient().AuthenticatedAsAdmin().GetAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings");
        response.CheckForbidden();
    }
    ...
    public async Task List_Should_Return_Settings_For_Power_Admin(string role)
    {
        ...
        var response = await _factory.CreateClient().Authenticated(role: role).GetAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings");
    ...
    public async Task List_Should_Use_Cache()
    {
        ...
        using var s = await scope.CreateOrganizationSettingAsync(org.Entity, OrgSettingsTestRegistryComponent.StringKey, "12345");

        var client = _factory.CreateClient().Authenticated(role: Roles.SystemAdmin);

        var response = await client.GetAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings");

        response.CheckOk();

        var arr = await response.AsArrayAsync();
        Assert.NotEmpty(arr);
        Assert.Contains(arr, t => t.Value<string>("name") == OrgSettingsTestRegistryComponent.StringKey && t.Value<string>("value") == "12345");

        s.Entity.Value = "67890";
        await s.SaveAsync();

        response = await client.GetAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings");

        arr = await response.CheckOk().AsArrayAsync();
        Assert.Contains(arr, t => t.Value<string>("name") == OrgSettingsTestRegistryComponent.StringKey && t.Value<string>("value") == "12345");
        Assert.DoesNotContain(arr, t => t.Value<string>("name") == OrgSettingsTestRegistryComponent.StringKey && t.Value<string>("value") == "67890");
        ...
        arr = await response.CheckOk().AsArrayAsync();
        Assert.Contains(arr, t => t.Value<string>("name") == OrgSettingsTestRegistryComponent.StringKey && t.Value<string>("value") == "67890");
    }

    [Fact]
    public async Task Update_Should_Require_Auth()
    {
        var response = await _factory.CreateClient().PutAsync("/v3/organizations/1/settings");
        response.CheckUnauthorized();
    }
    ...
    {
        var response = await _factory.CreateClient().Authenticated().PutAsync("/v3/organizations/1/settings");
        response.CheckForbidden();
    }
    ...
    public async Task Update_Should_Require_Setting_Name()
    {
        using var scope = _factory.Services.NewTestScope();
        using var org = await scope.CreateOrganizationAsync();
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().PutAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings");
    ...
    public async Task Update_Should_Not_Be_Available_To_Other_Org_Admin()
    {
        ...
        var response = await _factory.CreateClient()
            ...
            .PutAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings", new { name = OrgSettingsTestRegistryComponent.StringKey });
        response.CheckForbidden();
    }
    ...
    {
        using var scope = _factory.Services.NewTestScope();
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().PutAsync("/v3/organizations/1111/settings", new { name = "any" });
        response.CheckNotFound();
    }
    ...
    public async Task Update_Should_Return_Not_Found_If_No_Setting_Registered()
    {
        ...
        var response = await _factory.CreateClient()
            ...
            .PutAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings", new { name = "any" });
        response.CheckNotFound();
    }
    ...
    public async Task Update_Should_Return_Bad_Request_For_Invalid_Value_Provided(string name, string value)
    {
        ...
        var response = await _factory.CreateClient()
            .AuthenticatedAsSystemAdmin()
            .PutAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings", new { name, value });
        response.CheckBadRequest();
    }
    ...
    public async Task Update_Should_Return_Ok_If_Valid_Value_Provided(string name, string value)
    {
        ...
        var setting = await scope.Db.OrganizationSettings.AsNoTracking()
            .SingleAsync(s => s.Name == name && s.OrganizationId == org.Entity.OrganizationId);
    ...
    public async Task Update_Should_Add_New_Setting_If_Not_Exists()
    {
        ...
        await client.CheckSettingReturnedAsync(org, OrgSettingsTestRegistryComponent.StringKey, null);

        var response = await client.PutAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings",
            new { name = OrgSettingsTestRegistryComponent.StringKey, value = "any" });

        response.CheckOk();

        Assert.NotNull(await scope.Db.OrganizationSettings.SingleAsync(s
            => s.OrganizationId == org.Entity.OrganizationId && s.Name == OrgSettingsTestRegistryComponent.StringKey && s.Value == "any"));

        // check that cache is invalidated
        await client.CheckSettingReturnedAsync(org, OrgSettingsTestRegistryComponent.StringKey, "any");
    }
    ...
    public async Task Update_Should_Update_Existing_Setting()
    {
        ...
        using var setting = await scope.CreateOrganizationSettingAsync(org.Entity, OrgSettingsTestRegistryComponent.StringKey, "initial");

        var client = _factory.CreateClient().AuthenticatedAsSuperAdmin();

        await client.CheckSettingReturnedAsync(org, OrgSettingsTestRegistryComponent.StringKey, "initial"); // cache current value
        ...
        var updatedSetting = await scope.Db.OrganizationSettings.AsNoTracking()
            .SingleAsync(s => s.OrganizationId == org.Entity.OrganizationId && s.Name == OrgSettingsTestRegistryComponent.StringKey);

        Assert.Equal("updated", updatedSetting.Value);

        // check that cache is invalidated
        await client.CheckSettingReturnedAsync(org, OrgSettingsTestRegistryComponent.StringKey, "updated");
    }
    ...
    public async Task Update_Should_Remove_Existing_Setting_If_Value_Is_Not_Set(string value)
    {
        ...
        Assert.False(await scope.Db.OrganizationSettings.AnyAsync(s
            => s.OrganizationId == org.Entity.OrganizationId && s.Name == OrgSettingsTestRegistryComponent.StringKey));
    ...
    public async Task Update_Should_Do_Nothing_If_Value_Is_Not_Set_And_No_Setting_Exists(string value)
    {
        ...
        Assert.False(await scope.Db.OrganizationSettings.AsNoTracking().AnyAsync());
    }

    [Fact]
    public async Task Batch_Update_Should_Require_Auth()
    {
        var response = await _factory.CreateClient().PostAsync("/v3/organizations/1/settings");
        response.CheckUnauthorized();
    }
    ...
    {
        var response = await _factory.CreateClient().Authenticated().PostAsync("/v3/organizations/1/settings");
        response.CheckForbidden();
    }
    ...
    public async Task Batch_Update_Should_Require_Request_Body()
    {
        using var scope = _factory.Services.NewTestScope();
        using var org = await scope.CreateOrganizationAsync();
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().PostAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings");
        response.CheckBadRequest();
    }
    ...
    public async Task Batch_Update_Should_Require_At_Least_One_Setting()
    {
        ...
        var response = await _factory.CreateClient()
            ...
            .PostAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings", Array.Empty<object>());
        response.CheckBadRequest();
    }
    ...
    public async Task Batch_Update_Should_Return_Not_Found_If_No_Org_Exists()
    {
        ...
        var response = await _factory.CreateClient()
            .AuthenticatedAsSuperAdmin()
            .PostAsync("/v3/organizations/1111/settings", new[] { new { name = "any" } });
        response.CheckNotFound();
    }
    ...
    public async Task Batch_Update_Should_Return_Not_Found_If_No_Setting_Registered()
    {
        ...
        var response = await _factory.CreateClient()
            .AuthenticatedAsSystemAdmin()
            .PostAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings", new[] { new { name = "any" } });
        response.CheckNotFound();
    }
    ...
    public async Task Batch_Update_Should_Return_Bad_Request_For_Invalid_Value_Provided(string name, string value)
    {
        ...
        var response = await _factory.CreateClient()
            .AuthenticatedAsSystemAdmin()
            .PostAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings", new[] { new { name, value } });
        response.CheckBadRequest();
    }
    ...
    public async Task Batch_Update_Should_Create_Update_And_Delete_Entries()
    {
        ...
        await scope.CreateOrganizationSettingAsync(org.Entity, OrgSettingsTestRegistryComponent.StringKey, "to be updated");
        await scope.CreateOrganizationSettingAsync(org.Entity, OrgSettingsTestRegistryComponent.EmailKey, "to@be.removed");
        ...
        Assert.Collection(arr.OrderBy(a => a.Value<string>("name")),
            t =>
            {
        ...
        var settings = await scope.Db.OrganizationSettings.AsNoTracking().OrderBy(s => s.Name).ToArrayAsync();
...
{
    public static async Task CheckSettingReturnedAsync(this HttpClient client, IDisposableEntity<Organization> org, string name, string value)
    {
        var response = await client.GetAsync($"/v3/organizations/{org.Entity.OrganizationId}/settings");

        var arr = await response.CheckOk().AsArrayAsync();
        Assert.Contains(arr, t => t.Value<string>("name") == name && t.Value<string>("value") == value);
    }
}