...
namespace Eventuras.WebApi.Tests.Controllers.Notifications
{
    public class EmailNotificationsControllerTest : IClassFixture<CustomWebApiApplicationFactory<Startup>>, IDisposable
    {
        ...
        [Fact]
        public async Task Should_Create_Notifications_In_Db_With_No_Event_Binding()
        {
            using var scope = _factory.Services.NewTestScope();
        ...
        [Fact]
        public async Task Should_Bind_Notifications_To_Event_And_Current_Org()
        {
            using var scope = _factory.Services.NewTestScope();
            using var org = await scope.CreateOrganizationAsync();
            using var user = await scope.CreateUserAsync();
        ...
        [Fact]
        public async Task Should_Bind_Notifications_To_The_Given_Product_And_Filter_Recipient_List()
        {
            using var scope = _factory.Services.NewTestScope();
            using var org = await scope.CreateOrganizationAsync();
            using var evt = await scope.CreateEventAsync();
        ...
        [Fact]
        public async Task Should_Set_Error_For_Recipient_In_Case_Of_A_Delivery_Failure()
        {
