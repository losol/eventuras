...
public class EventCollectionControllerTest : IClassFixture<CustomWebApiApplicationFactory<Startup>>, IDisposable
{
    ...
    public async Task Should_Return_Collection_List_Sorted_By_Name()
    {
        ...
        content.CheckArray((token, c) => token.CheckEventCollection(c), c1.Entity, c2.Entity);
    }
    ...
    public async Task Should_Not_Return_Collections_From_Other_Organization()
    {
        ...
        using var member1 = await scope.CreateOrganizationMemberAsync(adminOfOrg1.Entity, org1.Entity, role: Roles.Admin);

        var client = _factory.CreateClient().AuthenticatedAs(adminOfOrg1.Entity, Roles.Admin);
    ...
    public async Task Should_Not_Allow_To_Create_New_Collection_For_Non_Current_Org()
    {
        ...
        await client.PostAsync("/v3/events/collections", new StringContent(json, Encoding.UTF8, "application/json"));
    ...
    public async Task Should_Allow_To_Create_New_Collection_To_Admin_Of_The_Current_Org()
    {
        ...
        var response = await client.PostAsync("/v3/events/collections",
            new
            {
                name = "Test",
                organizationId = org.Entity.OrganizationId,
    ...
    public async Task Should_Return_Not_Found_When_Updating_Non_Existing_Collection()
    {
        ...
        var response = await client.PutAsync("/v3/events/collections/202",
            new StringContent(JsonConvert.SerializeObject(new
                {
                    name = "Updated",
                    organizationId = 1,
    ...
    public async Task Should_Not_Allow_To_Update_Collection_For_Non_Current_Org()
    {
        ...
        await client.PutAsync($"/v3/events/collections/{collection.Entity.CollectionId}", new StringContent(json, Encoding.UTF8, "application/json"));
