...
public class EventCollectionMappingControllerTests : IClassFixture<CustomWebApiApplicationFactory<Startup>>
{
    private readonly CustomWebApiApplicationFactory<Startup> _factory;

    public EventCollectionMappingControllerTests(CustomWebApiApplicationFactory<Startup> factory)
    {
    ...
    public async Task Create_Should_Return_Not_Found_For_Unknown_Event()
    {
        ...
        var response = await client.PutAsync($"/v3/events/10001/collections/{collection.Entity.CollectionId}", new StringContent("", Encoding.UTF8));
    ...
    public async Task Create_Should_Return_Not_Found_For_Unknown_Collection()
    {
        ...
        var response = await client.PutAsync($"/v3/events/{@event.Entity.EventInfoId}/collections/10001", new StringContent("", Encoding.UTF8));
    ...
    public async Task Should_Not_Allow_To_Map_Not_Accessible_Event()
    {
        ...
        var response = await client.PutAsync($"/v3/events/{@event.Entity.EventInfoId}/collections/{collection.Entity.CollectionId}",
    ...
    public async Task Should_Create_Mapping()
    {
        ...
        Assert.NotNull(await scope.Db.EventCollectionMappings.SingleOrDefaultAsync(m
            => m.EventId == @event.Entity.EventInfoId && m.CollectionId == collection.Entity.CollectionId));
    }
    ...
    public async Task Should_Return_Ok_When_Removing_Non_Existing_Mapping()
    {
        ...
        var response = await client.DeleteAsync($"/v3/events/{@event.Entity.EventInfoId}/collections/{collection.Entity.CollectionId}");
        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
    }
