...
public class EventCertificatesControllerTest : IClassFixture<CustomWebApiApplicationFactory<Startup>>, IDisposable
{
    ...
    {
        var response = await _factory.CreateClient().GetAsync("/v3/event/1001/certificates");
    ...
    {
        var response = await _factory.CreateClient().Authenticated().GetAsync("/v3/event/1001/certificates");
    ...
    {
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().GetAsync("/v3/event/1001/certificates");
    ...
    public async Task List_Should_Be_Available_For_Power_Admin(string role)
    {
        ...
        var response = await _factory.CreateClient().Authenticated(role: role).GetAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates");
    ...
    public async Task List_Can_Be_Empty()
    {
        ...
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().GetAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates");
    ...
    public async Task List_Should_Not_List_Certificates_From_Another_Event()
    {
        ...
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().GetAsync($"/v3/event/{e2.Entity.EventInfoId}/certificates");
    ...
    public async Task List_Should_Use_Paging()
    {
        ...
        var json = await response.CheckOk().AsTokenAsync();
        json.CheckPaging(1, 3, (token, c) => token.CheckCertificate(c), c1.Entity, c2.Entity);
        ...
        json.CheckPaging(2, 3, (token, c) => token.CheckCertificate(c), c3.Entity);
    }
    ...
    {
        var response = await _factory.CreateClient().GetAsync("/v3/event/1001/certificates/preview");
        response.CheckUnauthorized();
    }
    ...
    {
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().GetAsync("/v3/event/1001/certificates/preview");
        response.CheckNotFound();
    }
    ...
    {
        var response = await _factory.CreateClient().Authenticated().GetAsync("/v3/event/1001/certificates/preview");
        response.CheckForbidden();
    }
    ...
    public async Task Should_Allow_Power_Admin_To_Preview_Event_Certificate(string role)
    {
        ...
        var response = await _factory.CreateClient().Authenticated(role: role).GetAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates/preview");
    ...
    {
        var response = await _factory.CreateClient().PostAsync("/v3/event/1001/certificates/issue");
        response.CheckUnauthorized();
    }
    ...
    {
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().PostAsync("/v3/event/1001/certificates/issue");
        response.CheckNotFound();
    }
    ...
    public async Task Should_Not_Allow_Regular_User_To_Issue_Event_Certificate()
    {
        ...
        var response = await _factory.CreateClient().Authenticated().PostAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates/issue");
    ...
    public async Task Should_Allow_Power_Admin_To_Issue_Event_Certificate(string role)
    {
        ...
        var response = await _factory.CreateClient().Authenticated(role: role).PostAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates/issue");
    ...
    public async Task Should_Issue_No_Certificates_For_Event_Without_Registrations()
    {
        ...
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().PostAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates/issue");
    ...
    public async Task Should_Only_Issue_Certificates_For_Finished_Registrations()
    {
        ...
        using var u2 = await scope.CreateUserAsync();
        using var r1 = await scope.CreateRegistrationAsync(evt.Entity, u1.Entity);
        using var r2 = await scope.CreateRegistrationAsync(evt.Entity, u2.Entity, Registration.RegistrationStatus.Finished);

        var emailExpectation = _factory.EmailSenderMock.ExpectEmail()
    ...
    public async Task Should_Only_Issue_Certificates_Once()
    {
        ...
        using var evt = await scope.CreateEventAsync(organization: org.Entity);
        using var user = await scope.CreateUserAsync();
        using var reg = await scope.CreateRegistrationAsync(evt.Entity, user.Entity, Registration.RegistrationStatus.Finished);
        using var cert = await scope.CreateCertificateAsync(reg.Entity);
    ...
    public async Task Issue_Certificate_Should_Use_Send_Query_Param()
    {
        ...
        _factory.EmailSenderMock.Verify(s => s.SendEmailAsync(It.IsAny<EmailModel>()), Times.Never);
    }
    ...
    {
        var response = await _factory.CreateClient().PostAsync("/v3/event/1001/certificates/update");
        response.CheckUnauthorized();
    }
    ...
    {
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().PostAsync("/v3/event/1001/certificates/update");
        response.CheckNotFound();
    }
    ...
    public async Task Should_Not_Allow_Regular_User_To_Update_Event_Certificate()
    {
        ...
        var response = await _factory.CreateClient().Authenticated().PostAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates/update");
    ...
    public async Task Should_Allow_Power_Admin_To_Update_Event_Certificate(string role)
    {
        ...
        var response = await _factory.CreateClient().Authenticated(role: role).PostAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates/update");
    ...
    public async Task Should_Update_No_Certificates_For_Event_Without_Registrations()
    {
        ...
        var response = await _factory.CreateClient().AuthenticatedAsSuperAdmin().PostAsync($"/v3/event/{evt.Entity.EventInfoId}/certificates/update");
