...
public class EventProductVariantsControllerTests : IClassFixture<CustomWebApiApplicationFactory<Startup>>
{
    ...
    public async Task Should_Not_Require_Auth_To_List_Product_Variants()
    {
        ...
        var response = await client.GetAsync($"/v3/events/{evt.Entity.EventInfoId}/products/{product.Entity.ProductId}/variants");
        response.CheckOk();
    ...
    {
        var client = _factory.CreateClient();
        var response = await client.GetAsync("/v3/events/123/products/4456/variants");
    ...
    public async Task Should_Return_Not_Found_When_Listing_Variants_For_Unknown_Product()
    {
        ...
        var client = _factory.CreateClient();
        var response = await client.GetAsync($"/v3/events/{evt.Entity.EventInfoId}/products/4456/variants");
        response.CheckNotFound();
    }
    ...
    public async Task List_Should_Not_Return_Archived_Variants()
    {
        ...
        var token = await response.AsArrayAsync();
        token.CheckArray((t, v) => t.CheckProductVariant(v), v2.Entity);
    }
    ...
    public async Task Should_Allow_Authenticated_User_To_List_Product_Variants(string role)
    {
        ...
        var token = await response.AsArrayAsync();
        token.CheckArray((t, v) => t.CheckProductVariant(v), v1.Entity, v2.Entity);
    }
    ...
    public async Task Add_Should_Be_Available_For_Org_Admin()
    {
        ...
        var variant = await scope.Db.ProductVariants.SingleOrDefaultAsync(p => p.ProductId == product.Entity.ProductId);
    ...
    public async Task Add_Should_Be_Available_For_Power_Users(string role)
    {
        ...
        var response = await client.PostAsync($"/v3/events/{evt.Entity.EventInfoId}/products/{product.Entity.ProductId}/variants",
            new
            {
                name = "test",
            });
    ...
    public async Task Archive_Should_Return_NotFound_For_Non_Existing_Variant()
    {
        ...
        var client = _factory.CreateClient().AuthenticatedAsSystemAdmin();
        var response = await client.DeleteAsync($"/v3/events/{evt.Entity.EventInfoId}/products/{p.Entity.ProductId}/variants/3");
        response.CheckNotFound();
    }
    ...
    public async Task Archive_Should_Be_Available_For_Org_Admin()
    {
        ...
        var updatedVariant = await scope.Db.ProductVariants.AsNoTracking()
