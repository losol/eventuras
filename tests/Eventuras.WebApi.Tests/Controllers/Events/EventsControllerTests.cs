...
public class EventsControllerTests : IClassFixture<CustomWebApiApplicationFactory<Startup>>, IDisposable
{
    ...
    {
        using var scope = _factory.Services.NewTestScope();
        using var e1 = await scope.CreateEventAsync(dateStart: SystemClock.Instance.Today().PlusDays(2), archived: true);
        using var e2 = await scope.CreateEventAsync(dateStart: SystemClock.Instance.Today().PlusDays(2), archived: false);
    ...
    public static object[][] GetDateMatchingFilterTestParams()
    {
        ...
        return new[]
        {
            ...
            new object[]
            {
                DateFilter.Intersect("I3.1", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(-10), today.PlusDays(-5)),
            },
             ...
             * Filter: [-------------]
             */
            new object[] { DateFilter.Intersect("I3.2", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(-10), today) },
            ...
            new object[]
            {
                DateFilter.Intersect("I3.3", today.PlusDays(-10), today.PlusDays(10), today.PlusDays(-5), today.PlusDays(5)),
            },
             ...
             * Filter:               [--------]
             */
            new object[] { DateFilter.Intersect("I3.4", today.PlusDays(-5), today.PlusDays(5), today, today.PlusDays(5)) },

            /*
             * Event:     [-------------------]
             * Filter:               [-----------------]
             */
            new object[] { DateFilter.Intersect("I3.5", today.PlusDays(-5), today.PlusDays(5), today, today.PlusDays(10)) },
            ...
            new object[]
            {
                DateFilter.Intersect("I3.6", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(5), today.PlusDays(10)),
            },
            ...
            new object[]
            {
                DateFilter.Intersect("I3.7", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(-10), today.PlusDays(10)),
            },
            ...
            new object[]
            {
                DateFilter.Contain("C3.1", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(-10), today.PlusDays(10)),
            },
        };
    }
    ...
    public static object[][] GetDateNotMatchingFilterTestParams()
    {
        ...
        return new[]
        {
            ...
            new object[]
            {
                DateFilter.Intersect("~I3.1", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(-10), today.PlusDays(-6)),
            },
            ...
            new object[]
            {
                DateFilter.Intersect("~I3.2", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(6), today.PlusDays(10)),
            },
            ...
            new object[]
            {
                DateFilter.Contain("~C3.1", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(-10), today.PlusDays(-5)),
            },
             ...
             * Filter: [-------------]
             */
            new object[] { DateFilter.Contain("~C3.2", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(-10), today) },
            ...
            new object[]
            {
                DateFilter.Contain("~C3.3", today.PlusDays(-10), today.PlusDays(10), today.PlusDays(-5), today.PlusDays(5)),
            },
             ...
             * Filter:               [--------]
             */
            new object[] { DateFilter.Contain("~C3.4", today.PlusDays(-5), today.PlusDays(5), today, today.PlusDays(5)) },

            /*
             * Event:     [-------------------]
             * Filter:               [-----------------]
             */
            new object[] { DateFilter.Contain("~C3.5", today.PlusDays(-5), today.PlusDays(5), today, today.PlusDays(10)) },
            ...
            new object[]
            {
                DateFilter.Contain("~C3.6", today.PlusDays(-5), today.PlusDays(5), today.PlusDays(5), today.PlusDays(10)),
            },
        };
    }
    ...
    public async Task Should_Filter_Event_List_By_OrganizationId()
    {
        ...
        using var evt1 = await scope.CreateEventAsync(organization: org1.Entity,
            organizationId: org1.Entity.OrganizationId,
            dateStart: SystemClock.Instance.Today().PlusDays(1));
        using var evt2 = await scope.CreateEventAsync(organization: org2.Entity,
            organizationId: org2.Entity.OrganizationId,
            dateStart: SystemClock.Instance.Today().PlusDays(1));
    ...
    {
        using var scope = _factory.Services.NewTestScope();
        using var evt = await scope.CreateEventAsync("asdf", organizationId: 1, slug: "test", archived: true);
    ...
    public async Task Should_Create_Event_With_Max_Data(string role)
    {
        ...
        var evt = await scope.Db.EventInfos.AsNoTracking().SingleAsync(e => e.Slug == "test");
    ...
    public async Task Should_Update_Event(string role)
    {
        ...
        var updated = await scope.Db.EventInfos.AsNoTracking().SingleAsync(e => e.EventInfoId == evt.Entity.EventInfoId);
...
public class DateFilter
{
    ...
    public string ToQueryString()
    {
        ...
        if (FilterStart.HasValue) parts.Add($"start={FilterStart:yyyy-MM-dd}");

        if (FilterEnd.HasValue) parts.Add($"end={FilterEnd:yyyy-MM-dd}");

        if (Matching.HasValue) parts.Add($"period={Matching.Value.ToString().ToLower()}");
