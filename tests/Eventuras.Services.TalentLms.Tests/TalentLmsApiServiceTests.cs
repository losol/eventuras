...
{
    private readonly SingletonHttpClientFactory _httpClientFactory = new();
    ...
    public static object[][] GetInvalidTalentLmsUserSignInData()
    {
        return new[]
        {
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = null, FirstName = "Test", LastName = "Test", Password = "Test", Login = "Test" },
            },
            new object[] { new TalentLmsUserSignUpRequest { Email = "", FirstName = "Test", LastName = "Test", Password = "Test", Login = "Test" } },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "invalid", FirstName = "Test", LastName = "Test", Password = "Test", Login = "Test" },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = null, LastName = "Test", Password = "Test", Login = "Test" },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "", LastName = "Test", Password = "Test", Login = "Test" },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = " ", LastName = "Test", Password = "Test", Login = "Test" },
            ...
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = null, Password = "Test", Login = "Test" },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = "", Password = "Test", Login = "Test" },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = " ", Password = "Test", Login = "Test" },
            ...
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = "Test", Password = null, Login = "Test" },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = "Test", Password = "", Login = "Test" },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = "Test", Password = " ", Login = "Test" },
            ...
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = "Test", Password = "Test", Login = null },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = "Test", Password = "Test", Login = "" },
            },
            new object[]
            {
                new TalentLmsUserSignUpRequest { Email = "valid@email.com", FirstName = "Test", LastName = "Test", Password = "Test", Login = " " },
