...
public class Create_Or_Update_Order_Should
{
    ...
    public void Credit_OrderLine_If_Product_Exists_In_Invoiced_Order()
    {
        ...
        var registration = new Registration
        {
            Orders = new List<Order>
            {
                new()
                {
                    OrderLines = new List<OrderLine>
                    {
                        Helpers.GetOrderLine(1, 100, 1, 1),
        ...
        var dto = new List<OrderDTO>
        {
            Helpers.GetOrderDto(1, 100, variantId: 2),
        };
    ...
    public void Credit_And_Remove_Products_From_Invoiced_Order()
    {
        ...
        var registration = new Registration
        {
            Orders = new List<Order>
            {
                new()
                {
                    OrderLines = new List<OrderLine>
                    {
                        Helpers.GetOrderLine(1, 100, 5, 1),
                    },
                },
            },
        };
        ...
        var dto = new List<OrderDTO>
        {
            Helpers.GetOrderDto(1, variantId: 1, price: 100, quantity: 0),
        };
    ...
    public void Create_New_Order_With_One_Orderline_When_New_Product_Is_Added()
    {
        ...
        var ordersToAdd = new List<OrderDTO>
        {
            Helpers.GetOrderDto(4, 800), // new product
            Helpers.GetOrderDto(1, 1000), // existing product
        };
    ...
    public void Create_New_Order_When_Product_Is_Removed()
    {
        ...
        {
            Helpers.GetOrderDto(2, variantId: 1, price: 400, quantity: 0),
        };
        var expectedItems = new List<OrderDTO>
        {
            Helpers.GetOrderDto(1, 1000),
    ...
    public void Create_New_Order_When_Variant_Is_Changed()
    {
        ...
        var orderitems = new List<OrderDTO>
        {
            Helpers.GetOrderDto(2, variantId: 2, price: 600, quantity: 1), // Small Dinner
        };
        var expectedItems = new List<OrderDTO>
        {
            Helpers.GetOrderDto(1, 1000),
            Helpers.GetOrderDto(3, 200, 2),
            Helpers.GetOrderDto(2, variantId: 2, price: 600, quantity: 1), // large Dinner
        };
    ...
    public void Update_Existing_Order_When_A_Draft_Exists()
    {
        ...
        registration.Orders.Add(new Order
        {
            OrderLines = new List<OrderLine>
            {
                Helpers.GetOrderLine(4, 800),
            },
        });
        var orderitems = new List<OrderDTO>
        {
            Helpers.GetOrderDto(4, 800, 2),
        };
        var expectedOrderlines = new List<OrderLine>
        {
            Helpers.GetOrderLine(4, 800, 2),
        };
    ...
    public void Not_Add_Items_With_Zero_Quantity()
    {
        ...
        var registration = new Registration
        {
            Orders = new List<Order>
            {
                new()
                {
                    OrderLines = new List<OrderLine>
                    {
                        Helpers.GetOrderLine(1, 1000),
                        Helpers.GetOrderLine(2, 1000, 0),
                    },
                },
            },
        };
        ...
        {
            Helpers.GetOrderDto(1, 1000),
            Helpers.GetOrderDto(2, 1000, 0),
            Helpers.GetOrderDto(3, 1000, 0),
            Helpers.GetOrderDto(4, 1000, 0),
        };
