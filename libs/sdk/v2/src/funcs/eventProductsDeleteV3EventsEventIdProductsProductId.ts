...
export async function eventProductsDeleteV3EventsEventIdProductsProductId(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteV3EventsEventIdProductsProductIdRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    operationID: "delete_/v3/events/{eventId}/products/{productId}",
    oAuth2Scopes: [],
