...
export async function registrationsDeleteV3RegistrationsId(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteV3RegistrationsIdRequest$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "delete_/v3/registrations/{id}",
    oAuth2Scopes: [],
