...
export enum GetV3OrganizationsOrganizationIdMembersUserIdRolesAcceptEnum {
  applicationJson = "application/json",
  textJson = "text/json",
  textPlain = "text/plain",
}

export async function organizationMemberRolesGetV3OrganizationsOrganizationIdMembersUserIdRoles(
  client: EventurasSDKCore,
  request: operations.GetV3OrganizationsOrganizationIdMembersUserIdRolesRequest,
...
> {
  ...
  const context = {
    operationID:
      "get_/v3/organizations/{organizationId}/members/{userId}/roles",
    oAuth2Scopes: [],
