...
export enum PutV3OrganizationsOrganizationIdAcceptEnum {
  applicationJson = "application/json",
  textJson = "text/json",
  textPlain = "text/plain",
}

export async function organizationsPutV3OrganizationsOrganizationId(
  ...
  Result<
    operations.PutV3OrganizationsOrganizationIdResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutV3OrganizationsOrganizationIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    operationID: "put_/v3/organizations/{organizationId}",
    oAuth2Scopes: [],
  ...
  >(
    M.text(
      200,
      operations.PutV3OrganizationsOrganizationIdResponse$inboundSchema,
    ),
    M.json(
      200,
      operations.PutV3OrganizationsOrganizationIdResponse$inboundSchema,
