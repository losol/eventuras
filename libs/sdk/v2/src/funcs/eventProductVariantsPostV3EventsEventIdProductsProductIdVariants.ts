...
export async function eventProductVariantsPostV3EventsEventIdProductsProductIdVariants(
...
> {
  ...
  const body = encodeJSON("body", payload.NewProductVariantDto, {
    explode: true,
  });
  ...
  const context = {
    operationID: "post_/v3/events/{eventId}/products/{productId}/variants",
    oAuth2Scopes: [],
