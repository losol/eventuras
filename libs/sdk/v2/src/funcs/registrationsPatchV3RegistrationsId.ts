...
export async function registrationsPatchV3RegistrationsId(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchV3RegistrationsIdRequest$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "patch_/v3/registrations/{id}",
    oAuth2Scopes: [],
