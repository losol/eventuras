...
export enum GetV3EventsEventIdProductsProductIdVariantsAcceptEnum {
  applicationJson = "application/json",
  textJson = "text/json",
  textPlain = "text/plain",
}

export async function eventProductVariantsGetV3EventsEventIdProductsProductIdVariants(
  ...
  Result<
    operations.GetV3EventsEventIdProductsProductIdVariantsResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const path = pathToFunc("/v3/events/{eventId}/products/{productId}/variants")(
    pathParams,
  );
  ...
  const context = {
    operationID: "get_/v3/events/{eventId}/products/{productId}/variants",
    oAuth2Scopes: [],
