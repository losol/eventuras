...
export interface Env {
  EVENTURASSDK_BEARER?: string | undefined;

  EVENTURASSDK_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  EVENTURASSDK_BEARER: z.string().optional(),

  EVENTURASSDK_DEBUG: z.coerce.boolean().optional(),
});
