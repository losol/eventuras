...
async function run() {
  await eventurasSDK.notifications.getV3NotificationsId({
    id: 193888,
  });
...
import { notificationsGetV3NotificationsId } from "eventuras-sdk-v2/funcs/notificationsGetV3NotificationsId.js";
...
async function run() {
  const res = await notificationsGetV3NotificationsId(eventurasSDK, {
    id: 193888,
  });
...
async function run() {
  await eventurasSDK.notifications.getV3Notifications({});
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { notificationsGetV3Notifications } from "eventuras-sdk-v2/funcs/notificationsGetV3Notifications.js";
...
async function run() {
  const res = await notificationsGetV3Notifications(eventurasSDK, {});
