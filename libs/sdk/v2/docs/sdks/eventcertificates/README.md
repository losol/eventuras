...
async function run() {
  await eventurasSDK.eventCertificates.getV3EventIdCertificates({
    id: 746981,
  });
...
import { eventCertificatesGetV3EventIdCertificates } from "eventuras-sdk-v2/funcs/eventCertificatesGetV3EventIdCertificates.js";
...
async function run() {
  const res = await eventCertificatesGetV3EventIdCertificates(eventurasSDK, {
    id: 746981,
  });
...
async function run() {
  await eventurasSDK.eventCertificates.getV3EventIdCertificatesPreview({
    id: 527755,
  });
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { eventCertificatesGetV3EventIdCertificatesPreview } from "eventuras-sdk-v2/funcs/eventCertificatesGetV3EventIdCertificatesPreview.js";
...
async function run() {
  const res = await eventCertificatesGetV3EventIdCertificatesPreview(eventurasSDK, {
    id: 527755,
  });
...
async function run() {
  await eventurasSDK.eventCertificates.postV3EventIdCertificatesIssue({
    id: 25450,
  });
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { eventCertificatesPostV3EventIdCertificatesIssue } from "eventuras-sdk-v2/funcs/eventCertificatesPostV3EventIdCertificatesIssue.js";
...
async function run() {
  const res = await eventCertificatesPostV3EventIdCertificatesIssue(eventurasSDK, {
    id: 25450,
  });
...
async function run() {
  await eventurasSDK.eventCertificates.postV3EventIdCertificatesUpdate({
    id: 697126,
  });
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { eventCertificatesPostV3EventIdCertificatesUpdate } from "eventuras-sdk-v2/funcs/eventCertificatesPostV3EventIdCertificatesUpdate.js";
...
async function run() {
  const res = await eventCertificatesPostV3EventIdCertificatesUpdate(eventurasSDK, {
    id: 697126,
  });
