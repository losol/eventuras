...
async function run() {
  const result = await eventurasSDK.registrations.getV3Registrations({});
...
import { registrationsGetV3Registrations } from "eventuras-sdk-v2/funcs/registrationsGetV3Registrations.js";
...
async function run() {
  const res = await registrationsGetV3Registrations(eventurasSDK, {});
...
async function run() {
  const result = await eventurasSDK.registrations.postV3Registrations({});
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { registrationsPostV3Registrations } from "eventuras-sdk-v2/funcs/registrationsPostV3Registrations.js";
...
async function run() {
  const res = await registrationsPostV3Registrations(eventurasSDK, {});
...
async function run() {
  const result = await eventurasSDK.registrations.getV3RegistrationsId({
    id: 166279,
  });
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { registrationsGetV3RegistrationsId } from "eventuras-sdk-v2/funcs/registrationsGetV3RegistrationsId.js";
...
async function run() {
  const res = await registrationsGetV3RegistrationsId(eventurasSDK, {
    id: 166279,
  });
...
async function run() {
  const result = await eventurasSDK.registrations.putV3RegistrationsId({
    id: 925215,
  });
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { registrationsPutV3RegistrationsId } from "eventuras-sdk-v2/funcs/registrationsPutV3RegistrationsId.js";
...
async function run() {
  const res = await registrationsPutV3RegistrationsId(eventurasSDK, {
    id: 925215,
  });
...
async function run() {
  await eventurasSDK.registrations.patchV3RegistrationsId({
    id: 726380,
  });
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { registrationsPatchV3RegistrationsId } from "eventuras-sdk-v2/funcs/registrationsPatchV3RegistrationsId.js";
...
async function run() {
  const res = await registrationsPatchV3RegistrationsId(eventurasSDK, {
    id: 726380,
  });
...
async function run() {
  await eventurasSDK.registrations.deleteV3RegistrationsId({
    id: 82536,
  });
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { registrationsDeleteV3RegistrationsId } from "eventuras-sdk-v2/funcs/registrationsDeleteV3RegistrationsId.js";
...
async function run() {
  const res = await registrationsDeleteV3RegistrationsId(eventurasSDK, {
    id: 82536,
  });
...
async function run() {
  const result = await eventurasSDK.registrations.postV3RegistrationsMeEventId({
    eventId: 46514,
  });
...
```typescript
import { EventurasSDKCore } from "eventuras-sdk-v2/core.js";
import { registrationsPostV3RegistrationsMeEventId } from "eventuras-sdk-v2/funcs/registrationsPostV3RegistrationsMeEventId.js";
...
async function run() {
  const res = await registrationsPostV3RegistrationsMeEventId(eventurasSDK, {
    eventId: 46514,
  });
