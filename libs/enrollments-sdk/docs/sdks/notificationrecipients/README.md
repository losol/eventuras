...
async function run() {
  await enrollmentsSDK.notificationRecipients.getV3NotificationsIdRecipients({
    id: 202307,
  });
...
import { notificationRecipientsGetV3NotificationsIdRecipients } from "enrollments-sdk/funcs/notificationRecipientsGetV3NotificationsIdRecipients.js";
...
async function run() {
  const res = await notificationRecipientsGetV3NotificationsIdRecipients(enrollmentsSDK, {
    id: 202307,
  });
