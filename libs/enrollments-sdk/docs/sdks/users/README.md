...
async function run() {
  const result = await enrollmentsSDK.users.getV3UsersMe({});
...
import { usersGetV3UsersMe } from "enrollments-sdk/funcs/usersGetV3UsersMe.js";
...
async function run() {
  const res = await usersGetV3UsersMe(enrollmentsSDK, {});
...
async function run() {
  const result = await enrollmentsSDK.users.getV3UsersId({
    id: "<id>",
  });
...
```typescript
import { EnrollmentsSDKCore } from "enrollments-sdk/core.js";
import { usersGetV3UsersId } from "enrollments-sdk/funcs/usersGetV3UsersId.js";
...
async function run() {
  const res = await usersGetV3UsersId(enrollmentsSDK, {
    id: "<id>",
  });
...
async function run() {
  const result = await enrollmentsSDK.users.putV3UsersId({
    id: "<id>",
  });
...
```typescript
import { EnrollmentsSDKCore } from "enrollments-sdk/core.js";
import { usersPutV3UsersId } from "enrollments-sdk/funcs/usersPutV3UsersId.js";
...
async function run() {
  const res = await usersPutV3UsersId(enrollmentsSDK, {
    id: "<id>",
  });
...
async function run() {
  const result = await enrollmentsSDK.users.getV3Users({});
...
```typescript
import { EnrollmentsSDKCore } from "enrollments-sdk/core.js";
import { usersGetV3Users } from "enrollments-sdk/funcs/usersGetV3Users.js";
...
async function run() {
  const res = await usersGetV3Users(enrollmentsSDK, {});
...
async function run() {
  const result = await enrollmentsSDK.users.postV3Users({});
...
```typescript
import { EnrollmentsSDKCore } from "enrollments-sdk/core.js";
import { usersPostV3Users } from "enrollments-sdk/funcs/usersPostV3Users.js";
...
async function run() {
  const res = await usersPostV3Users(enrollmentsSDK, {});
