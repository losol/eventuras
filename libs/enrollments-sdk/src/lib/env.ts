...
export interface Env {
  ENROLLMENTSSDK_BEARER?: string | undefined;

  ENROLLMENTSSDK_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  ENROLLMENTSSDK_BEARER: z.string().optional(),

  ENROLLMENTSSDK_DEBUG: z.coerce.boolean().optional(),
});
