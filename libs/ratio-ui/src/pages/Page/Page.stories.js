...
exports.FluidMain = exports.DarkNavbar = exports.ImageNavbar = exports.Default = void 0;
var react_1 = require("react");
var Navbar_1 = require("../../core/Navbar/Navbar");
var Footer_1 = require("../../core/Footer/Footer");
var List_1 = require("../../core/List/List");
...
var PageDemo = function (_a) {
    var title = _a.title, imageNavbar = _a.imageNavbar, bgDark = _a.bgDark, fluid = _a.fluid;
    // Mirror Wrapper-like defaults
    var bgClass = imageNavbar
        ? 'bg-transparent z-10 absolute w-full py-1'
        : 'bg-transparent w-full py-1';
    var containerFlag = !fluid;
    return (<div className="min-h-screen flex flex-col">
      <Navbar_1.Navbar title={title} bgColor={bgClass} bgDark={bgDark} LinkComponent={AnchorLink}>
      ...
      <main id="main-content" className="flex-1">
        {/* Hero / global search */}
        <Section_1.Section id="search" container={containerFlag} padding="py-16 md:py-24" backgroundColorClass="bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950" className="border-b">
          ...
          <div className="flex flex-col md:flex-row gap-3 md:items-center">
            <input placeholder="Search company knowledge (⌘K)" className="flex-1 px-4 py-3 rounded border" aria-label="Global knowledge search"/>
        ...
        <Section_1.Section id="spaces" container={containerFlag}>
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <img src="https://placehold.co/800x500/png" alt="Spaces overview" className="w-full h-auto rounded shadow"/>
            <div>
        ...
        <Section_1.Section id="collections" container={containerFlag}>
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
            ...
            <img src="https://placehold.co/800x500/png" alt="Collections and citations" className="w-full h-auto rounded shadow"/>
          </div>
        </Section_1.Section>

        {/* Recently updated & quick links */}
        <Section_1.Section id="recent" container={containerFlag}>
        ...
        {/* Governance callout */}
        <Section_1.Section id="governance" container={containerFlag}>
      ...
      <Footer_1.Footer siteTitle={title}>
        <List_1.List>
          <List_1.List.Item className="mb-2"><a href="/">Home</a></List_1.List.Item>
          <List_1.List.Item className="mb-2"><a href="/privacy">Privacy</a></List_1.List.Item>
          <List_1.List.Item className="mb-2"><a href="/terms">Terms</a></List_1.List.Item>
        </List_1.List>
      </Footer_1.Footer>
    </div>);
};
...
exports.Default = {};
exports.ImageNavbar = { args: { imageNavbar: true } };
exports.DarkNavbar = { args: { bgDark: true } };
exports.FluidMain = { args: { fluid: true } };
