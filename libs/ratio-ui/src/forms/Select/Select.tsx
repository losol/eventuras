...
const styles = {
  ...
  button: {
    ...
    icon: 'h-4 w-4 text-(--text-subtle)',
  },
  value: 'flex-1 truncate text-left placeholder-shown:italic text-(--text)',
  ...
  item: {
    ...
    focused: 'bg-card-hover',
    selected: 'bg-primary-100 dark:bg-primary-800 font-medium',
